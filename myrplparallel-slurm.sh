...
#SBATCH -o rplpl-%N.%j.out # STDOUT
#SBATCH -e rplpl-%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:497599063817:awsnotify --message "RPLParallelJobDone"
